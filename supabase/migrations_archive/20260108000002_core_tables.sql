...
-- Description: Create profiles, plans, plan_members, and plan_invites tables
...
CREATE TABLE plan_members (
  ...
  -- Each user can only be a member of a plan once
...
-- Partial unique index: only one pending invite per email per plan
CREATE UNIQUE INDEX idx_plan_invites_unique_pending 
  ON plan_invites(plan_id, email) 
  WHERE accepted_at IS NULL;

-- Partial index for expiry checks on pending invites
...
-- ============================================================================
-- FUNCTION: Check plan access (now that plan_members exists)
-- ============================================================================
...
-- ============================================================================
-- FUNCTION: Auto-add owner as plan member on plan creation
-- ============================================================================
...
-- ============================================================================
-- FUNCTION: Auto-accept invite when user with matching email joins
-- ============================================================================
